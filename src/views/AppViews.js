    ...
    return (
      <>
        ...
        <div className="big-title">
                <h1>Whitelist an address and</h1>
                <h1>Send Non network token to it.</h1>
              </div>
          <br />
            <h3>
          Select a network
      ...
      <div>
        ...
        <span className='LargeButtonContainer'>
          ...
          >
            ...
            <p>
              ...
              Create a whitelist contract and share your pool "ID" with your friends to join!
            </p>
          </button>
        <br />
        <br />
        <br />
          ...
          >
            ...
            <p>
            Join a whitelist Dapp and get some cool tokens airdrop!
            </p>
          </button>
        </span>
      </div>
